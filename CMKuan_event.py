...
class Event:
    ...
    def init_setting(self):
        Event.__posMatrix.extend([
            [[100, 264],[712, 634],[98, 431]], # pos0
            [[87, 122],[623, 94],[199, 331]], # pos1
            [[543, 126],[479, 544],[333, 333]], # pos2
            [[444, 444],[200, 100],[277, 121]], # pos3
            [[555, 555],[300, 404],[431, 232]], # pos4
            [[112, 112],[455, 505],[387, 343]], # pos5
            [[334, 334],[511, 276],[41, 454]], # pos6
            [[443, 443],[12, 123],[721, 565]], # pos7
            [[554, 554],[99, 431],[345, 185]], # pos8
        ])
        for i in range(9):
